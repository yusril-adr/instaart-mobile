...
const UserDetailJobs = ({ navigation }) => {
    const AlertJob = () =>
        Alert.alert(
            "Peringatan !",
        ...
        <ScrollView>
            <View style={styles.container1}>
                <View style={{ width: 320, flexDirection: 'column', marginTop: 20, alignSelf: 'center', alignItems: 'center' }}>
                    ...
                    <View>
                        <Text style={styles.JobName}>Programmer</Text>
                        <Text style={{ fontSize: 18, textAlign: 'center', marginTop: 10 }}>Quinella</Text>
                    </View>
                    <TouchableOpacity onPress={() => navigation.navigate('EditJob')}>
                        <View style={{ flexDirection: 'row', backgroundColor: '#fff', height: 40, alignItems: 'center', borderRadius: 5, borderWidth: 1, borderColor: '#517fa4', marginTop: 20, alignSelf: 'center' }}>
                            <Icon name='edit'
                                type='font-awesome'
                                color='#517fa4'
                                size={28}
                                style={{ marginLeft: 7 }} />
                            <Text style={{ marginHorizontal: 10, color: '#517fa4', fontSize: 18 }}>Edit Pekerjaan</Text>
                        </View>
                    </TouchableOpacity>
                    <View>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('PostJob')}>
                            <View
                                ...
                                <Text
                                    style={{ marginLeft: 10, marginRight: 10, fontSize: 20, color: '#fff' }}>Tambah</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
