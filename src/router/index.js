...
import { Akun, Home, Jobs, Login, Search, Signup, Splash, Upload, detailPost, ProfilePage, LikePages, BookmarkPages, FollowerPages, FollowingPages, EditPortfolio, PostJob, detailJobs, EditProfile, editPassword, editPhoto, searchUser, Activity, UserDetailJobs, EditJob, ForgotPass, PekerjaanDibuat } from '../pages'
...
const MainApp = () => {
    return (
        ...
        >
            ...
            <Tab.Screen name="PekerjaanDibuat" component={PekerjaanDibuat} options={{ headerShown: false }} />
        </Tab.Navigator>
    )
}
